...
/*Dans ce fichier, on trouve les op�rations d'ajout,  de suppression,  d'affichage,  de recherche des livres existants dans le fichier "livres"
...
d'affichage dans la console mais on va l'adapter pour que ces resultats soient utils�s par la page web lister.*/
